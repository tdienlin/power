...
In short, it describes the probabilility of being able to cry "Eureka! I found it!", when in fact there was something that could be found. In other words, if there is an effect, how often will you find it in the long run? More specifically, the power of a study can be calculated once you know:
