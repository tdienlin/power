...
Now, let's imagine we're running a study to find out whether the privacy paradox exists. Because we cannot ask all `r n_pop` students, we're going to collect a sample. 

How many? Good question. 200 seems quite a lot -- that should do the job, right? So let's simulate a study by drawing a random sample of 200 people of our population. Will we find an effect ... ?
...
Before we wrap up, let us briefly address on another important concept.
